const translations = {
  fr: {
    ...
    heroIntro: "Étudiant en dernière année de Master et stagiaire de recherche, à l’interface du traitement du signal, de la vision, de l’estimation, de l’automatique et des systèmes embarqués, avec un axe académique marqué en radar et sonar.",
    ...
    profileBody: "Mon parcours relie ingénierie de l’information, mathématiques appliquées et expérimentation. J’aime passer de la théorie à l’implémentation : estimation robuste, détection, acquisition embarquée, simulation et validation. Je m’intéresse particulièrement au traitement du signal radar et sonar, à la décision statistique et au filtrage optimal.",
    ...
    p4Title: "Radar, sonar & détection statistique",
    p4Desc: "Un axe académique associant traitement du signal radar, systèmes sonar, détection de Neyman–Pearson, estimation de covariance et filtrage optimal. Les performances sont évaluées par courbes ROC et expériences de Monte-Carlo.",
    ...
    researchKicker: "Recherche actuelle / 04",
    ...
    pathKicker: "Parcours académique / 05",
    ...
    contactBody: "Ouvert aux postes d’ingénieur junior, à la R&D appliquée et aux doctorats financés ou industriels à partir d’octobre–novembre 2026, notamment en radar, sonar, traitement statistique du signal et systèmes multicapteurs.",
